...
function TradePasswordValidateRepayAll({ financing, dispatch }) {
  const setPassword = (e) => {
  ...
  const submit = () => {
    dispatch({
      type: 'financing/tradePasswordValidateRepayAll',
      payload: {
        busiType: 'T04',
        transPswd: financing.transPswd,
        money: financing.repayAllMoney,
...
export default connect(mapStateToProps)(TradePasswordValidateRepayAll);
